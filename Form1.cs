...
namespace Stockmarketprediction
{
    public partial class Form1 : Form
    {
        ...
        public string getid()
        {
            ...
            string query = "select isnull(max(uid)+1,500) from register";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
                ...
                if (match.Success)
                {
                    ...
                    string status = "0";
                    string str2 = "insert into register values (" + uid11 + ",'" + txtcateg.Text + "','" + txtdes.Text + "','" + txtbrwse.Text + "','" + textBox2.Text + "','" + textBox4.Text + "','" + textBox1.Text + "',"+status+")";
                    con.exec(str2);
